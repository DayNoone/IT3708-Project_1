...
public class Settings {
    ...
    public static final double OBSTACLE_SIZE = 20;
    public static double BOID_WIDHT = 50;
    public static double SCENE_WIDTH = 1800;
    public static double SCENE_HEIGHT = 800;

    public static double SEPERATION_WEIGHT = 5;
    public static double ALIGNMENT_WEIGHT = 5;
    public static double COHESION_WEIGHT = 5    ;
